...
<header class="header">
    ...
    <div class="header-right">
        ...
        <form action="logout" method="get" style="margin: auto 0">
            <button class="header-right__logout-button" type="submit">Salir</button>
        </form>
    </div>
</header>
        ...
        <c:forEach var="candidato" items="${candidatosList}" varStatus="loop">
            <tr>
                    ...
                    <div class="switch">
                        <c:choose>
                            <c:when test="${candidato.acceso == true}">
                                <input id="${candidato.curp}" type="checkbox" class="switch-input switch-1" checked>
                                <label for="${candidato.curp}" class="switch-label"></label>
                            </c:when>
                            <c:when test="${candidato.acceso == false}">
                                <input id="${candidato.curp}" type="checkbox" class="switch-input switch-1">
                                <label for="${candidato.curp}" class="switch-label"></label>
                            </c:when>
                        </c:choose>
                    </div>
                ...
                <td id="${candidato.curp}" class="page-container__table-tbody--td"
                    style="color: var(--mainColor);" onclick="modalDisplay(this.id, ${candidato.score_inteligencia},
                    ${candidato.score_trabajo})">
                ...
                <div id="modal-container-p_${candidato.curp}" class="modal-container">
                    <div id="modal-p_${candidato.curp}" class="modal-container__square modal-container__close">
                        <p class="modal-container__square--x" onclick="closeModal()">X</p>
                        <!--------------------------------------- Aquí se elíge modal vacío o lleno -------------------------------------------------->
                        <c:choose>
                            <c:when test="${candidato.status == true}">
